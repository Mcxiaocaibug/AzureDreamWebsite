document.addEventListener('DOMContentLoaded', () => {
    ...
    responsibilities.forEach(responsibility => {
        responsibility.addEventListener('mouseenter', () => {
            ...
            responsibility.style.background = 'rgba(0, 122, 255, 0.3)';
        });

        responsibility.addEventListener('mouseleave', () => {
            responsibility.style.transform = 'scale(1)';
            responsibility.style.background = 'rgba(0, 122, 255, 0.2)';
        });
    });
    ...
    document.querySelectorAll('.animate-on-scroll, .staff-card').forEach((element) => {
    ...
    if (applyBtn) {
        applyBtn.addEventListener('mouseenter', () => {
            ...
            applyBtn.style.boxShadow = '0 5px 20px rgba(0, 122, 255, 0.4)';
        });

        applyBtn.addEventListener('mouseleave', () => {
            applyBtn.style.transform = 'none';
            applyBtn.style.boxShadow = '0 5px 15px rgba(0, 122, 255, 0.3)';
        });
    }
}); 